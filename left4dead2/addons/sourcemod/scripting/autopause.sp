...
public void OnPluginEnd()
{
    ...
    delete crashedPlayers;
    delete generalCrashers;
    delete teamPlayers;
}
...
void Event_PlayerDisconnect(Event hEvent, char[] sEventName, bool dontBroadcast)
{
	...
	int team;
	if (teamPlayers.GetValue(sAuthId, team) && team == L4D_TEAM_SURVIVOR && (!IsClientInGame(client) || !IsPlayerAlive(client)))
	{
		if (convarDebug.BoolValue)
		{
...
void DebugLog(const char[] sMessage)
{
